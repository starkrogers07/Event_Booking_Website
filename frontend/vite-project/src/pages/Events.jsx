...
class EventsPage extends Component {
  ...
  modalConfirmHandler = () => {
    ...
    const requestBody = {
      query: `
          mutation createEvent($title: String!, $desc: String!, $price: Float!, $date: String!, $capacity: Int!) {
            createEvent(eventInput: {title: $title, description: $desc, price: $price, date: $date, capacity: $capacity}) {
              _id
              title
              description 
              price
  ...
  bookEventHandler = () => {
    ...
    if (eventDate <= currentDate) {
      alert('This event has already passed. Bookings are closed!');
      this.setState({ selectedEvent: null });
      return;
    }
    ...
    fetch("http://localhost:3000/graphql", {
      ...
      .then((resData) => {
        const updatedEvent = { ...this.state.selectedEvent };
        updatedEvent.capacity -= 1; // Reduce the capacity by 1
        ...
        {this.state.selectedEvent && (
          ...
          >
            ...
            <h2>
              ...
              <br /> Slots left: {this.state.selectedEvent.capacity}
            </h2>
